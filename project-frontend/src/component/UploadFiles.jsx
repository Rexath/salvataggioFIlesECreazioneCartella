...
export default class UploadFiles extends Component {
  ...
  componentDidMount() {
    UserServiceData.getFiles().then((response) => {
      this.setState({
  ...
  deleteFileClicked(event){
    ...
    setTimeout(() => 
      ...
      UserServiceData.deleteFile(JSON.stringify(this.state.selectedFile)).
        then(() => {
            console.log("ok");
            this.refreshFiles();
        })
  ...
  upload() {
    ...
    UserServiceData.upload(currentFile, (event) => {
      this.setState({
      ...
      .then((response) => {
        ...
        return UserServiceData.getFiles();
      })
      .then((files) => {
        this.setState({
